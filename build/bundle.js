(function () {
	...
	function ChartLine(options) {
		...
		if (!document.getElementById("svelte-11gj2p0-style")) add_css$6();
	...
	function create_main_fragment$7(component_1, ctx) {
		var div1, div0;
	...
	function Chart(options) {
		...
		if (!document.getElementById("svelte-1ozivce-style")) add_css$7();
	...
	function Page(options) {
		...
		if (!document.getElementById("svelte-py4awp-style")) add_css$8();
